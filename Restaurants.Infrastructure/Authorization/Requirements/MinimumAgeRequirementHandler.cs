...
) : AuthorizationHandler<MinimumAgeRequirement>
{
        ...
        MinimumAgeRequirement requirement)
    {
        ...
        var dateOfBirth = context.User.Claims.FirstOrDefault(x => x.Type == "DateOfBirth")?.Value;

        logger.LogInformation("User: {Email}, DateOfBirth: {DateOfBirth} - handling  MinimumAgeRequirement",
